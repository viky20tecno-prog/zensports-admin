        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-semibold leading-none tracking-tight"
              style={{ fontFamily: "'Sport Event','Space Grotesk',sans-serif", background: 'linear-gradient(90deg, #AE68FF, #C084FF)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
